import { Storage, StorageKey, StorageKeyReturnType, defaultValues } from '@tezos-x/octez.connect-wallet'

/**
 * In-memory storage for use in Node.js (replaces browser localStorage).
 * Also exposes getPrefixedKey() which DAppClient/WalletClient call directly.
 */
